...
def load_model(i_res, j_res, marker_density):
	image = np.load("/tmp/simple.py.npy")
	...
	rho_key = np.array([4000, 1])
	eta_key = np.array([1000000000000000000000000000, 1000000000000000000000000])
	mu_key = np.array([10000000000, 100000000000000000000])
	C_key = np.array([10, 10])
	sinphi_key = np.array([0.58778525229247314, 0.58778525229247314])
